      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          <p className="mb-6 text-gray-600">
            ...
            <a href="mailto:contact@freshfarm.com">contact@freshfarm.com</a>
            .
          </p>

          <p className="mb-6 text-gray-600">
            At www.freshfarm.com we consider the privacy of our visitors to be
            ...
            by www.freshfarm.com and how we use it.
          </p>
          ...
          <p className="mb-6 text-gray-600">
            Like many other Web sites, www.freshfarm.com makes use of log
          ...
          <p className="mb-6 text-gray-600">
            www.freshfarm.com uses cookies to store information about
          ...
          <ul className="list-disc list-inside mb-6 text-gray-600">
            ...
            <li className="mb-2">
              ...
              site's visitors based upon their visit to www.freshfarm.com and
